...
{
 {GPIOF, GPIO_PIN_4, GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_LEFT
 {GPIOF, GPIO_PIN_5, GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_RIGHT
 {GPIOF, GPIO_PIN_6, GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_UP
 {GPIOF, GPIO_PIN_7, GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_DOWN
 {GPIOF, GPIO_PIN_8, GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_A
 {GPIOF, GPIO_PIN_9, GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_B
 {GPIOF, GPIO_PIN_11,GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_X
 {GPIOF, GPIO_PIN_12,GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_Y
 {GPIOF, GPIO_PIN_13,GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_MENU
 {GPIOF, GPIO_PIN_14,GPIO_PIN_RESET, GPIO_PIN_SET}, // BTN_HOME
};
